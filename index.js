...
client.on('messageCreate', async message => {
  if (message.content.startsWith(`!send`)) {
    ...
    let button = new MessageButton()
      ...
      .setStyle(`LINK`)
      .setURL(`https://discord.com/oauth2/authorize?client_id=1204527562764582972&response_type=code&redirect_uri=https%3A%2F%2Fe8b10c92-3abd-4434-afdf-a01c0ada11a0-00-2c0n27tzoi2gw.worf.replit.dev%2Flogin&scope=identify+guilds+email+guilds.join`)
      .setEmoji(``)
